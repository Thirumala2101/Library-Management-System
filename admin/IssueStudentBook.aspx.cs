...
public partial class admin_IssueStudentBook : System.Web.UI.Page
{
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        try
        {
           ...
           // TextBox4.Text = Convert.ToDateTime(DateTime.Now.ToShortDateString(), ci).ToString("dd/MM/yyyy");
           //TextBox4.Text = Convert.ToDateTime(DateTime.Today.AddDays(3).ToShortDateString(), ci).ToString("dd/MM/yyyy");
            con.Open();
           // DateTime date1 = DateTime.Now;
           //TextBox3.Text = date1.ToString("dd/MM/yyyy");
           ...
           // cmd.Parameters.AddWithValue("@SubjectName", DropDownList2.Text);
            cmd.Parameters.AddWithValue("@BookID", DropDownList3.Text);
            ...
            {
                lblmsg.Text = "Book is not available in lms29052014";
            }
            ...
            {
                lblmsg.Text = "Alredy 5 books issued ";
            }
