<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="studentreturnbook.aspx.cs" Inherits="admin_studentreturnbook" %>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:CheckBox ID="chkRow" runat="server" AutoPostBack="true" 
                                OnCheckedChanged="chkTest_CheckedChanged" />
                        </ItemTemplate>
                    </asp:TemplateField>
...
<PagerStyle CssClass="pgr"></PagerStyle>
 ...
 <asp:GridView ID="gvSelected" runat="server" HeaderStyle-BackColor="#3AC0F2" HeaderStyle-ForeColor="White" style="margin-left: 0px" 
    AutoGenerateColumns="false"  CssClass="Grid"                    
