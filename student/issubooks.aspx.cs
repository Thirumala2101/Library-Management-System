...
public partial class student_issubooks : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack == true)
        {
            txtStudentId.Text = Session["Sname"].ToString();
        }
    ...
    private void Bind()
    {
        ...
        try
        {
            ...
            cmd.Parameters.AddWithValue("@StudentId", Session["Sname"].ToString());
